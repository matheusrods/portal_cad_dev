...
Class funcoes {
    ...
    public function gravarConversa($idConversa, $idUsuario, $inputUsuario, $respostaBot, $contextoConversa){
        ...
        $query = "
            INSERT INTO `logsBotsCad`.`logGuiaLinguagemHomolog` (`idConversa`, `usuario`, `input`, `resposta_bot`, `contexto`) 
        ...
        try{
            ...
            $arquivoLog = $this->geraLogExcecao("Log Bot Guia Linguagem - Homologação", "gravaConversa", $informacoesErro, $mat);
