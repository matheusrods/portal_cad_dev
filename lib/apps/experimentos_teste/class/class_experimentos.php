...
Class funcoes {
    ...
    public function consultaTemas(){
        ...
        $query = "SELECT * FROM experimentos_teste.temas WHERE ativo = 1;";
    ...
    public function consultaExperimentos($idTema = null){
        ...
        $db = New Database('experimentos');
        $query = "SELECT *
                    FROM experimentos_teste.experimentos a
                    LEFT JOIN experimentos_teste.experimentosTemas b ON a.idExperimento = b.idExperimento
                    LEFT JOIN experimentos_teste.temas c ON b.idTema = c.idTema
                    WHERE a.ativo = 1 AND b.idTema ".$filtroIdTema." GROUP BY a.idExperimento  ORDER BY dtExperimento DESC;";
        ...
        try{
            ...
            if($execQuery > 0){
                ...
                for($j = 0; $j < sizeof($execQuery); $j++){
                    ...
                    $queryTemasExperimento = "SELECT temas FROM experimentos_teste.experimentosTemas a
                                                LEFT JOIN experimentos_teste.temas b ON a.idTema = b.idTema
                                                WHERE a.idExperimento = ".$idExperimento.";";

                    $execQueryTemasExperimento = $db->DbGetAll($queryTemasExperimento);

                    $tagsExperimentos = '';

                    for($k = 0; $k < sizeof($execQueryTemasExperimento); $k++){
                        $tagsExperimentos = $tagsExperimentos.'
                            <div class="tagExperimento">
                                <div class="textoTagExperimento">'.$execQueryTemasExperimento[$k]['temas'].'</div>
                            </div>
                        ';
                    }
                    ...
                    $montaExperimentos = $montaExperimentos.$abreDivNestExperimento.'
                        <div class="divExperimento">
                            <a href="https://cad.bb.com.br/lib/apps/experimentos_teste/arquivos/'.$idExperimento.'.pdf" target="_blank" style="text-decoration: none;">
                                <div class="fotoCapaExperimento" style="background-image: url(https://cad.bb.com.br/lib/apps/experimentos_teste/arquivos/'.$idExperimento.'.png); background-position: bottom;">
                                    '.$tagsExperimentos.'
                                </div>
                            </a>
                            <div class="textoExperimento" style="align-self: stretch; height: 196px; padding: 32px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 16px; display: flex">
                                ...
                                <a href="https://cad.bb.com.br/lib/apps/experimentos_teste/arquivos/'.$idExperimento.'.pdf" target="_blank" style="text-decoration: none; margin-top: 2rem;">
            ...
            $retorno["mensagem"] = "<p style='font-size: 16px; font-weight: bold;'>Não foi possível consultar os experimentos_teste. Informe à equipe responsável o caminho a seguir: " . $arquivoLog."</p>";
        } finally {
            return ($retorno);
        }
    }
    ...
    public function filtraExperimentosTema($idTema){
        ...
        $query = "SELECT 
                        *
                    FROM experimentos_teste.experimentos a
                    LEFT JOIN experimentos_teste.temas b ON a.idExperimento = b.idTema
    ...
    public function adicionaExperimento(){
        ...
        $queryMontaSelect = "SELECT idTema, temas FROM experimentos_teste.temas WHERE ativo = 1 ORDER BY temas ASC;";
        ...
        $resposta['mensagem'] = '
            ...
            <script>
                ...
                $(".btnLimparExperimentos").on("click", function(){
                    ...
                    $("#previewExperimentos").attr("src","/lib/apps/experimentos_teste/arquivos/capaPreview.png");
                ...
                $(".btnEnviarExperimentos").click(function () {
                    var caminhoupload = "https://cad.bb.com.br/lib/class/uploadExperimento_teste.php";
