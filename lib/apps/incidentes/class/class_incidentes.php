...
Class funcoes{
    ...
    public function consultaIncidentes(){
        ...
        try{
            ...
            if ($execQuery > 0){
                ...
                $inicioTabelaIncidentes = '<img class= "imgCapaIncidentes" src="https://cad.bb.com.br/lib/img/apps/incidentes/capaIncidentes.svg"/ onload="datatable();" style="display:none;">
                                            <table class="table" id="tabelaIncidentes" style="width:100%; line-height:30px;">
                                                <thead>
                                                    <tr id="cabecalhoTabela" style="background-color:red;">
                                                        <th id="cabecalhoTabela" style="display:none;">Data Abertura</th>
                                                        <th id="cabecalhoTabela" style="display:none;">Data Encerramento</th>
                                                        ...
                                                        <th id="cabecalhoTabela">Motivo</th>
                ...
                $tabelaIncidentes = "";
                    for( $i=0; $i<sizeof($execQuery); $i++) {
                        ...
                        <tr>
                        <td style="display:none;">'.$execQuery[$i]['dataHoraAbertura'].'</td>
                        <td style="display:none;">'.$execQuery[$i]['dataHoraEncerramento'].'</td>
                        <td>'.$execQuery[$i]['numIntIssue'].'</td>
                        <td>'.$execQuery[$i]['tipo'].'</td>
                        <td>'.$execQuery[$i]['status'].'</td>
                        <td>'.$execQuery[$i]['ambiente'].'</td>
                        <td>'.$execQuery[$i]['motivo'].'</td>
                        <td>
                        ...
                        <td>
                            <img src="https://cad.bb.com.br/lib/apps/incidentes/img/navegacaoBtn.png" attr-idIntIssue ="'.$execQuery[$i]['numIntIssue'].'" class= "acessaIncidente">
                        </td>
                        </tr>';
                    }
    ...
    public function consultaTipoIncidente(){
        ...
        try{
            ...
            $informacoesErro = "erro: " . $e . "\n\\n\$query:" . $query;
            $arquivoLog = $this->geraLogExcecao("incidentes", "consultaTipoIncidente", $informacoesErro, $mat);
            $retorno["mensagem"] = "<p style='font-size: 16px; font-weight: bold;'>Não foi possível consultar os incidentes. Informe à equipe responsável o caminho a seguir: " . $arquivoLog."</p>";
        } finally {
            return ($retorno);
        }   
    ...
    public function pesquisaIncidentes($dadosPesquisa){
        ...
        try{ 
            ...
            if ($execQueryFiltro > 0){
                ...
                '<img class= "imgCapaIncidentes" src="https://cad.bb.com.br/lib/img/apps/incidentes/capaIncidentes.svg"/ onload="datatable();" style="display:none;">
                <table class="table" id="tabelaIncidentes" style="width:100%; line-height:30px;" >
                    <thead>                        
                        <tr id="cabecalhoTabela" style="background-color:red;">
                            <th id="cabecalhoTabela" style="display:none;">Data Abertura</th>
                ...
                for($i = 0; $i < sizeof($execQueryFiltro); $i++) {
                    ...
                    <tr>
                        <td style="display:none;">'.$execQueryFiltro[$i]['dataHoraAbertura'].'</td>
                        <td style="display:none;">'.$execQuery[$i]['dataHoraEncerramento'].'</td>
                        ...
                        <td>'.$execQueryFiltro[$i]['motivo'].'</td>
                        <td>
                            <img src="https://cad.bb.com.br/lib/apps/incidentes/img/iconeEditar.png" attr-idIntIssue ="'.$execQueryFiltro[$i]['numIntIssue'].'" class = "editaIncidente">
                            <img src="https://cad.bb.com.br/lib/apps/incidentes/img/iconeDeletar.png" attr-idIntIssue ="'.$execQueryFiltro[$i]['numIntIssue'].'" class= "deletaIncidente">
                            
                        </td>
                        <td><img src="https://cad.bb.com.br/lib/apps/incidentes/img/navegacaoBtn.png" attr-idIntIssue ="'.$execQueryFiltro[$i]['numIntIssue'].'" class= "acessaIncidente"></td>
                    </tr>';
                }
    ...
    function montaTelaCadastraIncidente(){
        ...
        $selectTipoIncidente = '<label for="tipoIncidenteCadastraIncidente">Tipo Incidente*</label><select name="tipoIncidenteCadastraIncidente" id="tipoIncidenteCadastraIncidente" class="camposObrigatorios" attr-campoobrigatoriopreenchido="0">'.$selectTipoIncidente.'</select>';
        ...
        $selectStatus = '<label for="selectStatusCadastraIncidente">Status*</label><select name="selectStatusCadastraIncidente" id="selectStatusCadastraIncidente" class="camposObrigatorios" attr-campoobrigatoriopreenchido="0">'.$selectStatus.'</select>';
        ...
        $selectAmbiente = '<label for="selectAmbienteCadastraIncidente">Ambiente*</label><select name="selectAmbienteCadastraIncidente" id="selectAmbienteCadastraIncidente" class="camposObrigatorios" attr-campoobrigatoriopreenchido="0">'.$selectAmbiente.'</select>';
            ...
            <div class="modalRegistraIncidente">
                <div class="divEsquerdaRegistraIncidente">
                    ...
                    <div class="divInputIntIssueRegistraIncidente">
                        ...
                        <input type="text" id="numIntIssueRegistraIncidente" class="camposObrigatorios" attr-campoobrigatoriopreenchido="0" placeholder="Nº INT/Issue"></input>
                    </div>
                    <div class="divInputDataAberturaIncidente">
                        <label for="dataAberturaRegistraIncidente">Data Abertura*</label>
                        <input type="date" id="dataAberturaRegistraIncidente" class="camposObrigatorios" attr-campoobrigatoriopreenchido="0" name="dataAberturaRegistraIncidente" max="'.date("Y-m-d").'"></input>
                    </div>
                    <div class="divInputHoraAberturaIncidente">    
                        <label for="horarioAberturaRegistraIncidente">Horário Abertura*</label>
                        <input type="time" id="horarioAberturaRegistraIncidente" class="camposObrigatorios" attr-campoobrigatoriopreenchido="0" name="horarioAberturaRegistraIncidente"></input>
                    </div>
                    <div class="divTextAreaMotivoRegistraIncidente">
                        <label for="motivoRegistraIncidente">Motivo</label>
                        <textarea id="motivoRegistraIncidente" placeholder="Motivo"></textarea>
                    </div>
                ...
                <div class="divDireitaRegistraIncidente">
                    ...
                    <div class="divNumDependenciaRegistraIncidente">
                        ...
                        <input type="text" id="numDependenciaRegistraIncidente" class="camposObrigatorios" attr-campoobrigatoriopreenchido="0" placeholder="Dependência abertura"></input>
                    </div>
                    <div class="divInputDataEncerramentoIncidente">
                        <label for="dataEncerramentoRegistraIncidente">Data Encerramento</label>
                        <input type="date" id="dataEncerramentoRegistraIncidente" name="dataEncerramentoRegistraIncidente" max="'.date("Y-m-d").'"></input>
                    </div>
                    <div class="divInputHoraEncerramentoIncidente">
                        <label for="horarioEncerramentoRegistraIncidente">Horário Encerramento</label>
                        <input type="time" id="horarioEncerramentoRegistraIncidente" name="horarioEncerramentoRegistraIncidente"></input>
                    </div>
                    <div class="divTextAreaObservacaoRegistraIncidente">
                        <label for="observacaoRegistraIncidente">Observação</label>
                        <textarea id="observacaoRegistraIncidente" placeholder="Observação"></textarea>
                    </div>
                    <div class="divInputResponsavelRegistraIncidente">
                        <label for="inputResponsavelRegistraIncidente">Responsável</label>
                        <textarea id="inputResponsavelRegistraIncidente" placeholder="Responsável"></textarea>
                    </div>
                </div>
            </div>
        ';
            ...
            <div class="modalRegistraIncidente">
                <div class="divEsquerdaRegistraIncidente">
                    ...
                    <div class="divInputIntIssueRegistraIncidente">
                        ...
                        <input type="text" id="numIntIssueEditaIncidente" value="'.$execQueryConsultaIncidentes[0]['numIntIssue'].'" attr-idIncidente = "'.$execQueryConsultaIncidentes[0]['id'].'" disabled></input>
                    </div>
                    <div class="divInputDataAberturaIncidente">
                        <label for="dataAberturaEditaIncidente">Data Abertura</label>
                        <input type="date" id="dataAberturaEditaIncidente" name="dataAberturaEditaIncidente" max="'.date("Y-m-d").'" value="'.$execQueryConsultaIncidentes[0]['dataAberturaFormatada'].'"></input>
                    </div>
                    <div class="divInputHoraAberturaIncidente">    
                        <label for="horarioAberturaEditaIncidente">Horário Abertura</label>
                        <input type="time" id="horarioAberturaEditaIncidente" name="horarioAberturaEditaIncidente" value="'.$execQueryConsultaIncidentes[0]['horaAberturaFormatada'].'"></input>
                    </div>
                ...
                <div class="divDireitaRegistraIncidente">
                    ...
                    <div class="divNumDependenciaEditaIncidente">
                        ...
                        <input type="text" id="numDependenciaEditaIncidente" value="'.$execQueryConsultaIncidentes[0]['dependencia'].'"></input>
                    </div>
                    <div class="divInputDataEncerramentoIncidente">
                        <label for="dataEncerramentoEditaIncidente">Data Encerramento</label>
                        <input type="date" id="dataEncerramentoEditaIncidente" name="dataEncerramentoEditaIncidente" max="'.date("Y-m-d").'" value="'.$execQueryConsultaIncidentes[0]['dataEncerramentoFormatada'].'"></input>
                    </div>
                    <div class="divInputHoraEncerramentoIncidente">
                        <label for="horarioEncerramentoEditaIncidente">Horário Encerramento</label>
                        <input type="time" id="horarioEncerramentoEditaIncidente" name="horarioEncerramentoEditaIncidente" value="'.$execQueryConsultaIncidentes[0]['horaEncerramentoFormatada'].'"></input>
                    </div>
    ...
    function consultaIncidentesCadastrados($numIntIssue){
        ...
        $queryConsultaIntIssue = "SELECT a.*,
                  date_format(dataHoraEncerramento, '%d/%m/%Y %H:%i:%s') as dataHoraEncerramentoFormatada,  
                  date_format(dataHoraAbertura, '%d/%m/%Y %H:%i:%s') as dataHoraAberturaFormatada, 
                  b.tipo, c.ambiente 
                  FROM incidentes.incidente a
                  LEFT JOIN incidentes.tipoIncidentes b on a.tipo = b.codigo
                  LEFT JOIN incidentes.ambiente c on a.ambiente = c.codigo where a.numIntIssue = '".$numIntIssue."'";

        $execQueryConsultaIntIssue = $db->DbGetAll($queryConsultaIntIssue);

        if(sizeof($execQueryConsultaIntIssue) == 0){
            $retorno['status'] = 0;
            $retorno['mensagem'] = 'Não foi localizado nenhum incodente com o nº'.$numIntIssue;
        } else {
            $retorno['status'] = 1;
            $retorno['mensagem'] = 'O incidente nº'.$numIntIssue.' já foi cadastrado.';
        }
        // echo ('sizeof >>> '.sizeof($execQueryConsultaIntIssue));
        // print_r($execQueryConsultaIntIssue);
        return json_encode($retorno);
    }
    ...
    function deletaIncidente($numIntIssue) {
        ...
        $queryConsultaId = "SELECT id FROM incidentes.incidente WHERE numIntIssue = '".$numIntIssue."' AND ativo = 1;";
    ...
    public function acessaIncidente ($idIncidente){
        $mat = $_SESSION['matricula'];
        ...
        $query = "SELECT a.*,
                  ...
                  FROM incidentes.incidente a
                  LEFT JOIN incidentes.tipoIncidentes b on a.tipo = b.codigo
                  LEFT JOIN incidentes.ambiente c on a.ambiente = c.codigo where a.numIntIssue = '".$idIncidente."'
        ...
        // $retorno = array();
        // $retorno["status"] = 1;
        // $retorno["mensagem"] = $query;
        // return $retorno;

        try{
            $execQueryAcessa = $db->DbGetAll($query);
            if ($execQueryAcessa > 0) {
                for($i = 0; $i < sizeof($execQueryAcessa); $i++){
                    $modalAcessaIncidente ='<div class = "janelaModal">
                                                <div class = "conteudoModal">
                                                    <div class = "modalConsultaEsquerdo"><div>
                                                        <p><span class="formAcessaIncidente">Tipo: </span>'.$execQueryAcessa[$i]['tipo'].'</p>
                                                        <p><span class="formAcessaIncidente">Número: </span>'.$execQueryAcessa[$i]['numIntIssue'].'</p>
                                                        <p>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                                <path d="M16.3633 1.90493H18.1816C19.1846 1.90493 20 2.75919 20 3.80986V18.0951C20 19.1443 19.1846 20 18.1816 20H1.81837C0.815436 20 0 19.145 0 18.0951V3.80986C0 2.76062 0.815436 1.90493 1.81837 1.90493H3.63674V4.76197H5.4551V0H7.27347V1.90493H12.7279V4.76197H14.5463V0H16.3646V1.90493H16.3633ZM2.72721 17.1422H6.36326V13.3331H2.72721V17.1422ZM6.36395 11.4282V7.61901H2.72789V11.4282H6.36395ZM8.18163 17.1422H11.8177V13.3331H8.18163V17.1422ZM11.8184 11.4282V7.61901H8.18231V11.4282H11.8184ZM13.6361 11.4282H17.2721V7.61901H13.6361V11.4282Z" fill="#888D95"/>
                                                            </svg>
                                                            <span class="formAcessaIncidente">Data Abertura: </span>'.$execQueryAcessa[$i]['dataHoraAberturaFormatada'].'</p>
                                                        <p><span class="formAcessaIncidente ">Motivo: </span>'.$execQueryAcessa[$i]['motivo'].'</p>
                                                        <p><span class="formAcessaIncidente ">Ambiente: </span>'.$execQueryAcessa[$i]['ambiente'].'</p>
                                                    </div></div>
                                                    <div class="modalConsultaDireito">
                                                        <div class= "conteudoModalConsultaDireito">
                                                            <p><span class="formAcessaIncidente">Status: </span>'.$execQueryAcessa[$i]['status'].'</p>
                                                            <p><span class="formAcessaIncidente">Dependência: </span>'.$execQueryAcessa[$i]['dependencia'].'</p>
                                                            <p>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                                    <path d="M16.3633 1.90493H18.1816C19.1846 1.90493 20 2.75919 20 3.80986V18.0951C20 19.1443 19.1846 20 18.1816 20H1.81837C0.815436 20 0 19.145 0 18.0951V3.80986C0 2.76062 0.815436 1.90493 1.81837 1.90493H3.63674V4.76197H5.4551V0H7.27347V1.90493H12.7279V4.76197H14.5463V0H16.3646V1.90493H16.3633ZM2.72721 17.1422H6.36326V13.3331H2.72721V17.1422ZM6.36395 11.4282V7.61901H2.72789V11.4282H6.36395ZM8.18163 17.1422H11.8177V13.3331H8.18163V17.1422ZM11.8184 11.4282V7.61901H8.18231V11.4282H11.8184ZM13.6361 11.4282H17.2721V7.61901H13.6361V11.4282Z" fill="#888D95"/>
                                                                </svg>
                                                            <span class="formAcessaIncidente">Data encerramento: </span>'.$execQueryAcessa[$i]['dataHoraEncerramentoFormatada'].'</p>
                                                            <p><span class="formAcessaIncidente ">Observação: </span>'.$execQueryAcessa[$i]['observacao'].'</p>
                                                            <p><span class="formAcessaIncidente ">Responsável: </span>'.$execQueryAcessa[$i]['responsavel'].'</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                $retorno = array();
                $retorno["status"] = 1;
                $retorno["mensagem"] = $modalAcessaIncidente;
            } else {
                $retorno = array();
                $retorno["status"] = 0;
                $retorno["mensagem"] = "Não foi possível consultar os tipos de incidentes nesse momento. Informe à equipe responsável. L473 - class_incidentes.php";
            }                                        
        } catch(Exception $e){
            $informacoesErro = "erro: " . $e . "\n\\n\$query:" . $query;
            $arquivoLog = $this->geraLogExcecao("incidentes", "acessaIncidente", $informacoesErro, $mat);
            $retorno["mensagem"] = "<p style='font-size: 16px; font-weight: bold;'>Não foi possível consultar os incidentes. Informe à equipe responsável o caminho a seguir: " . $arquivoLog."</p>";
