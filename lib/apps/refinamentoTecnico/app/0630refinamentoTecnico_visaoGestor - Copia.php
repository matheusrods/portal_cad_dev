                ...
                <div class="divEsquerdaFormularioSolicitacaoSolicitacoes">
                    ...
                    <div class="radio-container">
                        <label for="incluirManutencao">
                            ...
                            <span style="font-color=#646464;">Manutenção</span>
                        </label>
                    </div>
                ...
                <div class="nestFormularioJornadaPF">
                    ...
                    <div class="divDireitaFormularioSolicitacaoSolicitacoes">
                        ...
                        <div class="nestBtnProximaPagina">
                            <button type="button" class="btnCadastrar" >Próximo</button>
                        </div>    
                    </div>
                </div>

            </div>
            <div class = "divSolicitacaoJornadaTransacaoPF setorJornadaPF" id= "idNestSolicitaMensagemAtivaPf">
                <div class="linhaDivisoria"></div>
                <div class="nestFormularioJornadaTransacaoPFDuasColunas">
                    <div class="divEsquerdaFormularioSolicitacaoClientePF">
                        <div class="divItemFormularioSolicitacaoClientePF">
                            ...
                            <div class="divInputFormJornadaPF">
                                <input type="text" class="inputFormJornadaPF" id="temaProdutoMensagemAtiva" />
                            </div>
                        </div>
                        <div class="divItemFormularioSolicitacaoClientePF">    
                            <span class="itemFormulario">Qual o objetivo/escopo?</span>
                            <div class="divInputFormJornadaPF">
                                <input type="text" class="inputFormJornadaPF" id="objetivoMensagemAtivaPF" />    
                            </div>
                        </div>
                        <div class="radioComTitulo">
                            ...
                            <div class="radio-container">
                                <div class="nestAvisoTipoDisparoCampanha" id="divAvisoDisparoCampanhaMensagemAtivaPF">
                                        <div class="divAvisoTipoJornadaPF" >
                                            <span class="textoAvisoTipoDisparo" id="campanhaTextoAvisoJornadaPF" >mensagem enviada para um público pré-definido</span>
                                        </div>    
                                        <div class="setaBaixo"></div>
                                </div>
                            ...
                            <div class="radio-container">
                                <div class="nestAvisoTipoDisparo" id="divAvisoDisparoMotorMensagemAtivaPF">
                                    <div class="divAvisoTipoJornadaPF" >
                                        <span class="textoAvisoTipoDisparo" id="motorTextoAvisoJornadaPF">mensagem enviada a partir de uma interação do cliente registrada na BIC ou no VIP</span>
                                    </div>    
                                    <div class="setaBaixo"></div>
                                </div>
                            ...
                            <div class="radio-container">
                                <div class="nestAvisoTipoDisparo" id="divAvisoDisparoSistemaLegadoMensagemAtivaPF">
                                    <div class="divAvisoTipoJornadaPF" >
                                        <span class="textoAvisoTipoDisparo" id="sistemaLegadoTextoAvisoJornadaPF">mensagem enviada a partir de um gatilho desenvolvido no próprio sistema legado</span>
                                    </div>    
                                    <div class="setaBaixo"></div>
                                </div>
                            ...
                            <div class="radio-container">
                                <div class="nestAvisoTipoDisparo" id="divAvisoDisparoFaleComMensagemAtivaPF">
                                    <div class="divAvisoTipoJornadaPF" >
                                        <span class="textoAvisoTipoDisparo" id="faleComTextoAvisoJornadaPF">mensagem enviada de forma manual por meio do FaleCom</span>
                                    </div>    
                                    <div class="setaBaixo"></div>
                                </div>
                        ...
                        <div class="divItemFormularioSolicitacaoClientePF Clicar" id="divNumSalaTemplatePf">    
                            <div class="nestAvisoTipoDisparo" id="divAvisoNumSalaDebateTemplate">
                                <div class="divAvisoTipoJornadaPF" >
                                    <span class="textoAvisoTipoDisparo" id="numSalaDebateTemplateTextoAvisoPF">Informar o código da sala de debate</span>
                                </div>    
                                <div class="setaBaixo"></div>
                            </div>
                            <span class="itemFormulario">Para qual célula/sala de debate o template será disponibilizado?
