...
require_once $_SERVER["DOCUMENT_ROOT"] . "/lib/apps/refinamentoTecnico/class/class_refinamentoTecnico.php";
    ...
    <div class="textoCabecalhoSolicitacoes" style="width: 50%; align-content: center; margin-left: 10%;">
        ...
        <div class="subtituloTextoCabecalhoSolicitacoes">
            <p class="text-wrapper">
                Refinamento técnico: Registre e acompanhe suas solicitações de demandas para o CAD 👇
            </p>
        </div>
    </div>
...
<div class="conteudoSolicitacoes">
        ...
        <div class="abaAdicionarSolicitacoes Clicar" style="z-index: 2;">
            <div class="divAdicionarSolicitacoes">
                <div class="divTextoAdicionarSolicitacoes">
                    <img src="https://cad.bb.com.br/lib/apps/refinamentoTecnico/img/iconeArquivo.png"> Registrar
                </div>
            </div>
        </div>
    ...
    <div id="abaNovaSolicitacao">
        ...
        <div class="divFormularioNovaSolicitacaoSolicitacoes">
            <div class="nestBreadcrumbs">
                <div class="cabecalhoBreadcrumbs">
                    <img src="https://cad.desenv.bb.com.br/lib/apps/refinamentoTecnico/img/iconeCasaAzul.svg">
                    <span class="txtBreadcrumbs">Nova Jornada / Cliente PF / Mensagem Ativa</span>
                </div>
                <div class="divSecaoEtapasMsgeAtiva">
                    <img src="https://cad.desenv.bb.com.br/lib/apps/refinamentoTecnico/img/setaVolta.png" class="iconeSetaVoltar Clicar" id="setaVoltaJornadaPFMsgeAtivaPag">
                    <div class="celulaEtapa">
                        <img src="https://cad.desenv.bb.com.br/lib/apps/refinamentoTecnico/img/iconeNum1.svg">
                        <div class="barraProgresso"></div>
                        <div class="nomeEtapaBarraProgresso">Informações Básicas</div>
                    </div>
                    <div class="celulaEtapa">
                        <img src="https://cad.desenv.bb.com.br/lib/apps/refinamentoTecnico/img/iconeNum2.svg">
                        <div class="barraProgresso"></div>
                        <div class="nomeEtapaBarraProgresso">Detalhes do Disparo</div>
                    </div>
                    <div class="celulaEtapa">
                        <img src="https://cad.desenv.bb.com.br/lib/apps/refinamentoTecnico/img/iconeNum3.svg">
                        <div class="barraProgresso"></div>
                        <div class="nomeEtapaBarraProgresso">Detalhes da Mensagem</div>
                    </div>
                    <div class="celulaEtapa">
                        <img src="https://cad.desenv.bb.com.br/lib/apps/refinamentoTecnico/img/iconeNum4.svg">
                        <div class="barraProgresso"></div>
                        <div class="nomeEtapaBarraProgresso">Direcionamento para outros Canais</div>
                    </div>
                    <div class="celulaEtapa">
                        <img src="https://cad.desenv.bb.com.br/lib/apps/refinamentoTecnico/img/iconeNum5.svg">
                        <div class="barraProgresso"></div>
                        <div class="nomeEtapaBarraProgresso">Transbordo</div>
                    </div>
                    <div class="celulaEtapa">
                        <img src="https://cad.desenv.bb.com.br/lib/apps/refinamentoTecnico/img/iconeNum6.svg">
                        <div class="barraProgresso"></div>
                        <div class="nomeEtapaBarraProgresso">Mídias</div>
                    </div>
                    <div class="celulaEtapa">
                        <img src="https://cad.desenv.bb.com.br/lib/apps/refinamentoTecnico/img/iconeNum7.svg">
                        <div class="barraProgresso"></div>
                        <div class="nomeEtapaBarraProgresso">Acompanhamento</div>
                    </div>
                </div>
            </div>
         <form> 
            <div class="divPaginaForm" id="formPagina0" attr-numPagForm = "0">   
                <div class="nestFormularioNovasSolicitacoes">
                    <div class="divEsquerdaFormularioSolicitacaoSolicitacoes">
                        ...
                        <div class="radio-container">
                            <label for="incluirManutencao">
                                <input type="radio" id="incluirManutencao" name="necessidadeGestor" />
                                <div class="custom-radio">
                                    <span></span>
                                </div>
                                <span style="color=#646464;">Manutenção</span>
                            </label>
                        </div>

                        <div class="radio-container">
                            <label for="incluirNovaJornada">
                                <input type="radio" id="incluirNovaJornada" name="necessidadeGestor" />
                                <div class="custom-radio">
                                    <span></span>
                                </div>
                ...
                <div class = "divSolicitacaoJornadaPF setorJornadaPF">
                    ...
                    <div class="nestFormularioJornadaPF">
                        ...
                        <div class="divDireitaFormularioSolicitacaoSolicitacoes">
                                ...
                                <form >
                                    ...
                                    <div class="radio-container containerInputEAvisoPF">
                                        ...
                                        <label for="radioTransacaoPF">
                                            <input type="radio" id="radioTransacaoPF" name="tipoJornadaPF" value="transacaoPF" />
                                            <div class="custom-radio">
                                            <span></span>
                                            </div>
                                            <div class="nestRadioComAviso">
                                    ...
                                    <div class="radio-container containerInputEAvisoPF">
                                        <div class="nestAvisoTipoJornadaPF" id="divAvisoJornadaInformacionalPF">
                                            <div class="divAvisoTipoJornadaPF" >
                                    ...
                                    <div class="radio-container containerInputEAvisoPF">
                                        <div class="nestAvisoTipoJornadaPF" id="divAvisoJornadaQRCodePF">
                                            <div class="divAvisoTipoJornadaPF" >
                                                <span class="textoAvisoTipoJornadaPF" id="criacaoLinkTextoAvisoJornadaPF" ><strong>Criação de link/ QR Code:</strong>
                                                    Criação de link e/ou QR Code que faz o direcionamento para jornada do bot no WhatsApp PF, para utilização em outro canal, material ou peça publicitária   
                                                </span>
                                            </div>    
                                            <!--<div class="setaBaixo"></div>-->
                                        </div>
                                        <label for="radioCriacaoLinkQRCode">
                                            <input type="radio" id="radioCriacaoLinkQRCode" name="tipoJornadaPF" value="criacaoLinkQRCode" />
                                            <div class="custom-radio">
                                                <span></span>
                                            </div>
                                            <div class="nestRadioComAviso">
                                                <span>Criação de link/ QR Code</span>
                                                <div class="svgInterrogacao" id= "divIconeInterrogaCriaLink">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="31" height="28" viewBox="0 0 31 28" fill="none">
                                                        <path d="M30.4556 14.001C30.4556 21.7335 23.6379 28.002 15.2278 28.002C6.81772 28.002 0 21.7335 0 14.001C0 6.26845 6.81772 0 15.2278 0C23.6379 0 30.4556 6.26845 30.4556 14.001Z" fill="#E0E9FF"/>
                                                        <path d="M17.563 16.1768L13.8253 15.7221L15.9077 13.3527C16.6908 12.4273 17.207 11.7731 17.4562 11.3902C17.7232 10.9913 17.8566 10.5765 17.8566 10.1457C17.8566 9.60317 17.6609 9.17237 17.2693 8.85326C16.8777 8.53415 16.3349 8.3746 15.6407 8.3746C13.9143 8.3746 12.4993 9.17237 11.3958 10.7679L8.45898 9.04473C9.36671 7.67255 10.4257 6.65938 11.636 6.0052C12.8641 5.33507 14.2791 5 15.881 5C17.0557 5 18.1058 5.18349 19.0314 5.55047C19.9747 5.91744 20.7044 6.436 21.2206 7.10613C21.7367 7.76031 21.9948 8.51022 21.9948 9.35586C21.9948 10.1696 21.7723 10.9355 21.3274 11.6535C20.9002 12.3715 20.2328 13.2251 19.325 14.2143L17.563 16.1768ZM15.614 22.1123C14.8843 22.1123 14.2791 21.8969 13.7986 21.4661C13.318 21.0353 13.0777 20.5008 13.0777 19.8626C13.0777 19.2084 13.318 18.6579 13.7986 18.2112C14.2791 17.7485 14.8843 17.5171 15.614 17.5171C16.3438 17.5171 16.9489 17.7405 17.4295 18.1872C17.91 18.618 18.1503 19.1526 18.1503 19.7908C18.1503 20.429 17.91 20.9795 17.4295 21.4422C16.9489 21.8889 16.3438 22.1123 15.614 22.1123Z" fill="#465EFF"/>
                                                    </svg>
                            ...
                            <div class="nestBtnProximaPagina" id="idNest0PaginaJornadaPf">
                                <button type="button" class="btnCadastrar" id="btnProximo0NovaJornadaPF">Próximo</button>
                            </div>    
                        </div>
                    </div>
                </div>
            </div>    <!--fim div form pag0-->
            <div class="divPaginaForm" id="formPagina1" attr-numPagForm = "1">
                <div>
                    <!--<div class="linhaDivisoria"></div>-->
                    <div class="divItemFormularioSolicitacaoClientePF divItemFormularioLarguraParcial" >
                        <span class="itemFormulario">Qual o tema/produto?</span>
                        <div class="divInputFormJornadaPF">
                            <input type="text" class="inputFormJornadaPF" id="temaProdutoMensagemAtiva" placeholder="Escreva o nome"/>
                        </div>
                    </div>
                    <div class="divItemFormularioSolicitacaoClientePF divItemFormularioSolicitacaoLarguraMax">    
                        <span class="itemFormulario">Qual o objetivo/escopo?</span>
                        <div>
                            <textarea class="txtAreaMedioTransacao" name="objetivoMensagemAtivaPF" rows="7" cols="155" maxlength="200" placeholder= "Mensagem"></textarea>
                        </div>
                    </div>
                    <div class="nestBtnProximaPagina">
                        <button type="button" class="btnVoltar" id="btnVoltar0NovaJornadaPF">Voltar</button>
                        <button type="button" class="btnProximo" id="btnProximo1NovaJornadaPF">Próximo</button>
                    </div> 
                </div>   
            </div><!--fim div form pag1-->
            <div class="divPaginaForm" id="formPagina2" attr-numPagForm = "2">
                <div class="nestPerguntasFormulario">
                    <div class="divEsquerda">
                        <div class="radioComTitulo">
                            <span class="itemFormulario tituloRadioBtnFormulario">Como será realizado o disparo?</span>
                            <div class="radio-container">
                                <div class="nestAvisoTipoDisparoCampanha" id="divAvisoDisparoCampanhaMensagemAtivaPF">
                                    <div class="divAvisoTipoJornadaPF">
                                        <span class="textoAvisoTipoDisparo" id="campanhaTextoAvisoJornadaPF">mensagem enviada para um
                                            público pré-definido</span>
                                    </div>
                                    <!--<div class="setaBaixo"></div>-->
                                </div>
                                <label for="radioDisparoCampanha">
                                    <input type="radio" id="radioDisparoCampanha" name="detalhesDisparo" value="campanha" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <div class="nestRadioComAviso" id="divIconeInterrogaCampanhaMsgeAtivaPf">
                                        <span>Campanha</span>
                                        <div class="svgInterrogacao">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="31" height="28" viewBox="0 0 31 28"
                                                fill="none">
                                                <path
                                                    d="M30.4556 14.001C30.4556 21.7335 23.6379 28.002 15.2278 28.002C6.81772 28.002 0 21.7335 0 14.001C0 6.26845 6.81772 0 15.2278 0C23.6379 0 30.4556 6.26845 30.4556 14.001Z"
                                                    fill="#E0E9FF" />
                                                <path
                                                    d="M17.563 16.1768L13.8253 15.7221L15.9077 13.3527C16.6908 12.4273 17.207 11.7731 17.4562 11.3902C17.7232 10.9913 17.8566 10.5765 17.8566 10.1457C17.8566 9.60317 17.6609 9.17237 17.2693 8.85326C16.8777 8.53415 16.3349 8.3746 15.6407 8.3746C13.9143 8.3746 12.4993 9.17237 11.3958 10.7679L8.45898 9.04473C9.36671 7.67255 10.4257 6.65938 11.636 6.0052C12.8641 5.33507 14.2791 5 15.881 5C17.0557 5 18.1058 5.18349 19.0314 5.55047C19.9747 5.91744 20.7044 6.436 21.2206 7.10613C21.7367 7.76031 21.9948 8.51022 21.9948 9.35586C21.9948 10.1696 21.7723 10.9355 21.3274 11.6535C20.9002 12.3715 20.2328 13.2251 19.325 14.2143L17.563 16.1768ZM15.614 22.1123C14.8843 22.1123 14.2791 21.8969 13.7986 21.4661C13.318 21.0353 13.0777 20.5008 13.0777 19.8626C13.0777 19.2084 13.318 18.6579 13.7986 18.2112C14.2791 17.7485 14.8843 17.5171 15.614 17.5171C16.3438 17.5171 16.9489 17.7405 17.4295 18.1872C17.91 18.618 18.1503 19.1526 18.1503 19.7908C18.1503 20.429 17.91 20.9795 17.4295 21.4422C16.9489 21.8889 16.3438 22.1123 15.614 22.1123Z"
                                                    fill="#465EFF" />
                                            </svg>
                                        </div>
                                    </div>
                            ...
                            <div class="radio-container">
                                <div class="nestAvisoTipoDisparo" id="divAvisoDisparoMotorMensagemAtivaPF">
                                    <div class="divAvisoTipoJornadaPF">
                                        <span class="textoAvisoTipoDisparo" id="motorTextoAvisoJornadaPF">mensagem enviada a partir de
                                            uma interação do cliente registrada na BIC ou no VIP</span>
                                    </div>
                                    <!--<div class="setaBaixo"></div>-->
                                </div>
                                <label for="radioDisparoMotor">
                                    <input type="radio" id="radioDisparoMotor" name="detalhesDisparo" value="motorDeInteracoes" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <div class="nestRadioComAviso" id="divIconeInterrogaMotorMsgeAtivaPf">
                                        <span>Motor de Interações</span>
                                        <div class="svgInterrogacao">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="31" height="28" viewBox="0 0 31 28"
                                                fill="none">
                                                <path
                            ...
                            <div class="radio-container">
                                <div class="nestAvisoTipoDisparo" id="divAvisoDisparoSistemaLegadoMensagemAtivaPF">
                                    <div class="divAvisoTipoJornadaPF">
                                        <span class="textoAvisoTipoDisparo" id="sistemaLegadoTextoAvisoJornadaPF">mensagem enviada a
                                            partir de um gatilho desenvolvido no próprio sistema legado</span>
                                    </div>
                                    <!--<div class="setaBaixo"></div>-->
                                </div>
                                <label for="radioDisparoLegado">
                                    <input type="radio" id="radioDisparoLegado" name="detalhesDisparo" value="sistemaLegado" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <div class="nestRadioComAviso" id="divIconeInterrogaSistemaLegadoMsgeAtivaPf">
                                        <span>Sistema Legado</span>
                                        <div class="svgInterrogacao">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="31" height="28" viewBox="0 0 31 28"
                                                fill="none">
                                                <path
                            ...
                            <div class="radio-container">
                                <div class="nestAvisoTipoDisparo" id="divAvisoDisparoFaleComMensagemAtivaPF">
                                    <div class="divAvisoTipoJornadaPF">
                                ...
                                <label for="radioTemplateFaleCom">
                                    ...
                                    <div class="nestRadioComAviso" id="divIconeInterrogaFaleComMsgeAtivaPf">
                                        <span>Template FaleCom</span>
                                        <div class="svgInterrogacao">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="31" height="28" viewBox="0 0 31 28"
                                                fill="none">
                                                <path
                        ...
                        <div class="divItemFormularioSolicitacaoClientePF Clicar" id="divNumSalaTemplatePf">
                            <div class="nestAvisoTipoDisparo" id="divAvisoNumSalaDebateTemplate">
                                <div class="divAvisoTipoJornadaPF">
                                    <span class="textoAvisoTipoDisparo" id="numSalaDebateTemplateTextoAvisoPF">Informar o código da sala
                                        de debate</span>
                                </div>
                                <!--<div class="setaBaixo"></div>-->
                            </div>
                            <span class="itemFormulario" id="itemFormCelulaSalaTemplate">Para qual célula/sala de debate o template será disponibilizado?
                                <div class="svgInterrogacao" id="iconeInterrogacaoNumSalaDebateTemplatePf">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="31" height="20" viewBox="0 0 31 28" fill="none">
                                        <path
                                            d="M30.4556 14.001C30.4556 21.7335 23.6379 28.002 15.2278 28.002C6.81772 28.002 0 21.7335 0 14.001C0 6.26845 6.81772 0 15.2278 0C23.6379 0 30.4556 6.26845 30.4556 14.001Z"
                                            fill="#E0E9FF" />
                                        <path
                            ...
                            <div class="divInputFormJornadaPFReduzido " id="divInputNumSalaCelulaMsgeAtivaPf">
                                <input type="text" class="inputFormJornadaPF" id="numSalaCeluladispTemplate" />
                            </div>
                        </div>
                        <div class="divItemFormularioSolicitacaoClientePF Clicar" id="divSistemaLegadoResponsavel">
                            <span class="itemFormulario">Qual o sistema legado responsável pelo disparo?
                            </span>
                            <div class="divInputFormJornadaPFReduzido" id="divInputSistemaLegadoMsgeAtivaPf">
                                <input type="text" class="inputFormJornadaPF" id="sistemaLegadoResponsavel" />
                            </div>
                        </div>
                    </div>    <!-- Fim da Div Esquerda -->
                    <div class="divDireita">
                        <div class="radioComTitulo" id="divPerguntaAlinhamentoCRM">
                            <span class="itemFormulario tituloRadioBtnFormulario">Você já alinhou com o CRM? </span>
                            <div class="radio-container">
                                <label for="radioAlinhaCRMSim">
                                    <input type="radio" id="radioAlinhaCRMSim" name="alinhamentoCRM" value="sim" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Sim</span>
                            ...
                            <div class="radio-container">
                                <label for="radioAlinhaCRMNao">
                                    <input type="radio" id="radioAlinhaCRMNao" name="alinhamentoCRM" value="nao" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Não</span>
                        ...
                        <div class="divAvisoCrm" id="idDivAvisoCrm">
                            <span class="textoAvisoCrm">Por favor entrar em contato com a equipe do CRM</span>
                            <a href="https://humanograma.intranet.bb.com.br/uor/532010" target="_blank" style="text-decoration: none;">
                                <button type="button" class="btnAvisoCrm">VER EQUIPE</button>
                            </a>    
                        </div>
                        <div class="radioComTitulo" id="divPerguntaFormMartech">
                            <span class="itemFormulario tituloRadioBtnFormulario">Já tem o número do localizador do formulário Martech? </span>
                            <div class="radio-container">
                                <label for="radioRadioFormMartechSim">
                                    <input type="radio" id="radioRadioFormMartechSim" name="formMartech" value="sim" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Sim</span>
                            ...
                            <div class="radio-container">
                                <label for="radioRadioFormMartechNao">
                                    <input type="radio" id="radioRadioFormMartechNao" name="formMartech" value="nao" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Não</span>
                        ...
                        <div class="divAvisoFormMartech avisoFormMartechMsgeAtivaPf" >
                            <span class="textoAvisoFormMartech">Para consultar o localizador clique no botão ao lado e siga esse caminho:
                                                                <span class="textoCaminhoPlataforma">Gestão > Gestão de Campanhas > Campanhas</span>
                            </span>                                    
                            <a href="https://plataforma.atendimento.bb.com.br:49286/estatico/gaw-sabia/?cd_modo_uso=55&modo_tablet=false" target="_blank" style="text-decoration: none;">
                                <button type="button" class="btnAvisoMartech">Consultar</button>
                            </a>    
                        </div>
                        <div class="divAvisoFormMartech avisoFormMartechMsgeAtivaPf">
                            <span class="textoAvisoFormMartech">Se precisar de ajuda entre em contato com a equipe do CRM</span>                                    
                           <a href="https://humanograma.intranet.bb.com.br/uor/532010" target="_blank" style="text-decoration: none;">
                                <button type="button" class="btnAvisoMartech">Ver Equipe</button>
                            </a>    
                        </div>
                        <div class="divItemFormularioSolicitacaoClientePF Clicar" id="divNumFormularioMartech">
                            <span class="itemFormulario">Qual o número do localizador do formulário Martech?</span>
                            <div class="divInputFormJornadaPFReduzido" id="divInputNumFormularioMartech">
                                <input type="text" class="inputFormJornadaPF" id="numFormularioMartech" />
                            </div>
                        </div>
                    </div><!-- Fim da Div Direita -->
                </div><!--div sem classe -->
                <div class="nestBtnProximaPagina">
                    <button type="button" class="btnVoltar" id="btnVoltar1NovaJornadaPF">Voltar</button>
                    <button type="button" class="btnProximo" id="btnProximo2NovaJornadaPF">Próximo</button>
                </div>
            </div><!--Fim div FormPag2 -->
            <div class="divPaginaForm" id="formPagina3" attr-numPagForm = "3">
                <div class="divSuperiorPerguntasFormulario">
                    <div class="divEsquerda">
                        <div class="radioComTitulo" id="divPerguntaMaisDeUmRMEOuNao">
                            <span class="itemFormulario tituloRadioBtnFormulario">Será necessário o desenvolvimento de mais de uma mensagem/mais de um código no RME? </span>
                            <div class="radio-container">
                                <label for="radioSoUmRME">
                                    <input type="radio" id="radioSoUmRME" name="radioQtdeRme" value="somenteUmRME" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Somente 1 RME</span>
                                </label>
                            </div>
                            <div class="radio-container">
                                <label for="radioMaisdeUmRME">
                                    <input type="radio" id="radioMaisdeUmRME" name="radioQtdeRme" value="maisDeUmRME" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Mais de 1 RME</span>
                                </label>
                            </div>
                        </div>
                        <div class="divItemFormularioSolicitacaoClientePF Clicar" id="divQtdeRme">
                            <span class="itemFormulario tituloRadioBtnFormulario">Informe quantas mensagens/RMEs devem ser desenvolvidos e o escopo de cada uma</span>
                            <div class="divInputFormJornadaPFReduzido" id="divInputQtdeRme">
                                <input type="text" class="inputFormJornadaPF" id="numQtdeRme" />
                            </div>
                        </div>
                    </div>
                    <div class="divDireita">
                        <div class="divItemFormularioSolicitacaoClientePF">
                            <span class="itemFormulario">Qual a categoria da mensagem</span>
                            <div class="divSelectFiltroPesquisa Clicar">
                                <select name="categoriaMensagemAtiva" id="idCampoCategoriaMensagemAtiva" class="selectFiltroCategoriaMsge">
                                    <option>Institucional</option>
                                    <option>Legal</option>
                                    <option>Transacional</option>
                                    <option>Interna</option>
                                    <option> Mercadológica</option>
                                    <option>Relacional pessoal</option>
                                    <option> Relacional Negocial</option>
                                </select>    
                            </div>
                        </div>
                        <div class="divItemFormularioSolicitacaoClientePF" id= "codProdutoJornadaMsgeAtivaPf" >
                            <span class="itemFormulario">Qual o código do produto/modalidade (PRD)?</span>
                            <div class="divInputFormJornadaPF" id="divCodProduto">
                                <input type="text" class="inputFormJornadaPF" id="inputCodProduto"/>
                            </div>
                        </div>
                    </div>      
                </div>
                <div class="divInferiorPerguntasFormulario"> 
                    <div class="divItemFormularioSolicitacaoClientePF">
                        <div class="nestAvisoCamposVariaveisMsgeAtiva" id="divAvisoCamposVariaveisMsgeAtiva">
                            <div class="divAvisoJornadaPF">
                                <span class="textoAvisoCamposVariaveis" id="idCamposVariaveisTextoAvisoPF">Informar em qual ordem devem ser apresentados e um exemplo com a formatação. Além do nome do cliente, é possível incluir até 3 variáveis na mensagem ativa, desde que não ultrapasse o limite de 50 caracteres por dado variável, incluindo espaços</span>
                            </div>
                        </div>
                        <span class="itemFormulario">Quais campos variáveis serão utilizados na mensagem?
                            <div class="svgInterrogacao Clicar" id="divIconeInterrogacaoCamposVariaveisMsgeAtivaPf">
                                <svg xmlns="http://www.w3.org/2000/svg" width="31" height="20" viewBox="0 0 31 28" fill="none">
                                    <path
                                        d="M30.4556 14.001C30.4556 21.7335 23.6379 28.002 15.2278 28.002C6.81772 28.002 0 21.7335 0 14.001C0 6.26845 6.81772 0 15.2278 0C23.6379 0 30.4556 6.26845 30.4556 14.001Z"
                                            fill="#E0E9FF" />
                        ...
                        <div>
                            <textarea class="txtAreaMedioFormularioSolicitacaoPF" id="camposVariaveisMsgeAtivaPf" name="camposVariaveisMsgeAtivaPf" rows="7" cols="150" maxlength="200" placeholder= "Mensagem..."></textarea>
                        </div>
                    </div> 
                </div>
                <div class="nestBtnProximaPagina">
                    <button type="button" class="btnVoltar" id="btnVoltar2NovaJornadaPF">Voltar</button>
                    <button type="button" class="btnProximo" id="btnProximo3NovaJornadaPF">Próximo</button>
                </div>
            </div>
            <div class="divPaginaForm" id="formPagina4" attr-numPagForm = "4">
                <div class = "divEsquerda">
                    <div class="radioComTitulo" id="divPerguntaMsgeAtivaDirecionamentoApp">
                        <span class="itemFormulario tituloRadioBtnFormulario">A mensagem ativa prevê direcionamento para o App BB?</span>
                        <div class="radio-container">
                            <label for="radioMsgeAtivaDirecionamentoAppPfSim">
                                <input type="radio" id="radioMsgeAtivaDirecionamentoAppPfSim" name="radioMsgeAtivaDirecionamentoAppPf" value="direcionaApp" />
                                <div class="custom-radio">
                                    <span></span>
                                </div>
                                <span>Sim</span>
                        ...
                        <div class="radio-container">
                            <label for="radioMsgeAtivaDirecionamentoAppPfNao">
                                <input type="radio" id="radioMsgeAtivaDirecionamentoAppPfNao" name="radioMsgeAtivaDirecionamentoAppPf" value="naoDirecionaApp" />
                                <div class="custom-radio">
                                    <span></span>
                                </div>
                                <span>Não</span>
                ...
                <div class="divItemFormularioSolicitacaoClientePF divItemFormularioSolicitacaoLarguraMax" id="msgeAtivaPfDivTxtDirecionamentoAppCaminho">    
                    <span class="itemFormulario">Indique o caminho que o cliente deve seguir dentro do App BB para chegar na transação relacionada a mensagem</span>
                    <div>
                        <textarea class="txtAreaMedioTransacao" name="caminhoAppMsgeAtivaPf"  id="caminhoAppMsgeAtivaPf"  rows="7" cols="155" maxlength="200" placeholder= "Mensagem"></textarea>
                    </div>
                </div>
                <div class= "divCentralDeepLinkPf">
                    <div class = "divEsquerda">
                        <div class="radioComTitulo" id="divPerguntaMsgeAtivaDeeplink">
                            <div class="nestAvisoDeeplink" id="divAvisoDeeplink">
                                <div class="divAvisoDeeplink">
                                    <span class="textoAvisoDeeplink">O deeplink deve levar o cliente direto para a tela da transação relacionada a mensagem; deve funcionar nos dois principais sistemas operacionais - IOS e ANDROID - e caso o cliente não tenha o App BB instalado deve levar para a loja de aplicativos</span>
                                </div>
                            </div>
                            <span class="itemFormulario tituloRadioBtnFormulario" id="tituloRadioDeeplink">Você tem o deeplink do App BB que direciona para a transação relacionada a mensagem? 
                                <div class="svgInterrogacao Clicar" id="divIconeInterrogacaoDeeplink">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="31" height="20" viewBox="0 0 31 28" fill="none">
                                        <path
                                            d="M30.4556 14.001C30.4556 21.7335 23.6379 28.002 15.2278 28.002C6.81772 28.002 0 21.7335 0 14.001C0 6.26845 6.81772 0 15.2278 0C23.6379 0 30.4556 6.26845 30.4556 14.001Z"
                                            fill="#E0E9FF" />
                            ...
                            <div class="radio-container">
                                <label for="radioMsgeAtivaTemDeeplinkSim">
                                    <input type="radio" id="radioMsgeAtivaTemDeeplinkSim" name="radioMsgeAtivaTemDeeplink" value="temDeeplink" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Sim</span>
                            ...
                            <div class="radio-container">
                                <label for="radioMsgeAtivaTemDeeplinkNao">
                                    <input type="radio" id="radioMsgeAtivaTemDeeplinkNao" name="radioMsgeAtivaTemDeeplink" value="naoTemDeeplink" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Não</span>
                    ...
                    <div class="divDireitaDeeplink">
                        <div class="divAlertDeeplink divMsgeAtivaPfAlertDeeplink">
                            <span class="textoAlertDeeplink">A solicitação de deeplink é feita conforme este manual:</span>
                            <a href="https://canais.fontes.intranet.bb.com.br/plm/publico/playmobile/-/blob/master/src/esteira/doc-issues.md" target="_blank" style="text-decoration: none;">
                                <button type="button" class="btnAvisoCrm">VER MANUAL</button>
                            </a>    
                        </div>
                    </div>
                </div>    
                <div class="divItemFormularioSolicitacaoClientePF divItemFormularioSolicitacaoLarguraMax" id="divMsgeAtivaPfTxtDeeplink">    
                    <span class="itemFormulario">Informe o deeplink</span>
                    <div>
                        <textarea class="txtAreaMedioTransacao" name="msgeAtivaPfDeeplink" id="msgeAtivaPfDeeplink" rows="7" cols="155" maxlength="200" placeholder= "Mensagem"></textarea>
                    </div>
                </div>
                <div class="divEsquerda">
                    <div class="radioComTitulo" id="divPerguntaMsgeAtivaPfOutrosDirecionamentos">
                        <span class="itemFormulario tituloRadioBtnFormulario">A mensagem ativa prevê direcionamento para algum outro canal exceto App BB</span>
                        <div class="radio-container">
                            <label for="radioMsgeAtivaOutrosDirecionamentosPfSim">
                                <input type="radio" id="radioMsgeAtivaOutrosDirecionamentosPfSim" name="radioMsgeAtivaOutrosDirecionamentosPf" value="direcionaOutrosPf" />
                                <div class="custom-radio">
                                    <span></span>
                                </div>
                                <span>Sim</span>
                        ...
                        <div class="radio-container">
                            <label for="radioMsgeAtivaOutrosDirecionamentosPfNao">
                                <input type="radio" id="radioMsgeAtivaOutrosDirecionamentosPfNao" name="radioMsgeAtivaOutrosDirecionamentosPf" value="direcionaOutrosPf" />
                                <div class="custom-radio">
                                    <span></span>
                                </div>
                                <span>Não</span>
                ...
                <div class="divItemFormularioSolicitacaoClientePF divItemFormularioSolicitacaoLarguraMax" id="divMsgeAtivaPfTxtCaminhoOutrosDirecionamentos">    
                    <span class="itemFormulario">Informe o link e/ou caminho que o cliente deve seguir no canal</span>
                    <div>
                        <textarea class="txtAreaMedioTransacao" name="msgeAtivaPfTxtCaminhoOutrosDirecionamentos" id= "msgeAtivaPfTxtCaminhoOutrosDirecionamentos" rows="7" cols="155" maxlength="200" placeholder= "Mensagem"></textarea>
                    </div>
                </div>
                <div class="nestBtnProximaPagina">
                    <button type="button" class="btnVoltar" id="btnVoltar3NovaJornadaPF">Voltar</button>
                    <button type="button" class="btnProximo" id="btnProximo4NovaJornadaPF">Próximo</button>
                </div> 
            </div>
            <div class="divPaginaForm" id="formPagina5" attr-numPagForm = "5">
                <div class="nestPerguntasFormulario">
                    <div class="divEsquerda">
                        <div class="radioComTitulo" id="divPerguntaMsgeAtivaPfTransbordoHumano">
                            <span class="itemFormulario tituloRadioBtnFormulario"> A mensagem ativa prevê direcionamento para atendimento humano (transbordo)?</span>
                            <div class="radio-container">
                                <label for="radioHatransbordoHumanoSim">
                                    <input type="radio" id="radioHatransbordoHumanoSim" name="haTransbordoHumano" value="sim" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Sim</span>
                            ...
                            <div class="radio-container">
                                <label for="radioHaTransbordoHumanoNao">
                                    <input type="radio" id="radioHaTransbordoHumanoNao" name="haTransbordoHumano" value="nao" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Não</span>
                        ...
                        <div class="radioComTitulo" id="divPerguntaMsgeAtivaPfTransbordoNegociaUAC">
                            <span class="itemFormulario tituloRadioBtnFormulario"> O transbordo já foi negociado com a UAC?</span>
                            <div class="radio-container">
                                <label for="radioTransbordoNegociaUACSim">
                                    <input type="radio" id="radioTransbordoNegociaUACSim" name="TransbordoNegociaUAC" value="sim" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Sim</span>
                            ...
                            <div class="radio-container">
                                <label for="radioTransbordoNegociaUACNao">
                                    <input type="radio" id="radioTransbordoNegociaUACNao" name="TransbordoNegociaUAC" value="nao" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Não</span>
                        ...
                        <div class="divAlertaNegociaTransbordoUAC" id= "idAlertaNegociaTransbordoUAC">
                            <span class="textoAlertaNegociaUAC">Se precisar de ajuda entre em contato com: </span>
                            <a href="https://humanograma.intranet.bb.com.br/F0722856" target="_blank" style="text-decoration: none;">
                                <button type="button" class="btnAlertaNegociaUAC">Humanograma BB - Ana Paula</button>
                            </a>
                        </div>    
                    </div>
                    <div class="divDireita">
                        <div class="divItemFormularioSolicitacaoClientePF80Width">
                            <span class="itemFormulario"> O atendimento será realizado por célula/sala de debate específica ou atendimento geral?</span>
                            <div class="divSelectFiltroPesquisa Clicar">
                                <select name="categoriaformaAtendimento" id="idCampoCategoriaFormaAtendimentoMsgeAtiva" class="selectFiltroCategorias">
                                    <option>Célula específica</option>
                                    <option>Atendimento geral</option>
                                </select>    
                            </div>
                        </div>
                        <div class="divItemFormularioSolicitacaoClientePF80Width">
                            <span class="itemFormulario">  Qual sala de debate prestará o atendimento?</span>
                            <div class="divInputFormJornadaPF">
                                <input type="number" class="inputFormJornadaPF" id="numSalaDebateAtendimentoMsgeAtivaPf" placeholder=" número da sala..." min = "1">
                            </div>
                        </div>
                        <div class="divItemFormularioSolicitacaoClientePF80Width">
                            <span class="itemFormulario"> Quais dias e horários de atendimento da célula?</span>
                            <div class="divInputFormJornadaPF">
                                <input type="text" class="inputFormJornadaPF" id="diaHorarioAtendimentoCelulaMsgeAtivaPf">
                            </div>
                        </div>
                    </div>
                </div>
            </div>    
            <div class="divPaginaForm" id="formPagina6" attr-numPagForm = "6">
                <div class="nestPerguntasFormulario">
                    <div class="divEsquerda">
                        <div class="radioComTitulo" id="divPerguntaHaMidia">
                            <span class="itemFormulario tituloRadioBtnFormulario">Há alguma mídia (imagem, vídeo, figurinha, áudio ou documento) a ser incluída na transação?</span>
                            <div class="radio-container">
                                <label for="radioHaMidiaSim">
                                    <input type="radio" id="radioHaMidiaSim" name="haMidia" value="sim" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Sim</span>
                            ...
                            <div class="radio-container">
                                <label for="radioHaMidiaNao">
                                    <input type="radio" id="radioHaMidiaNao" name="haMidia" value="nao" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Não</span>
                        ...
                        <div class= "divNestUpload">
                            <span class="itemFormularioCinza">Faça o upload da mídia para verificar se atende as especificações permitidos pela Meta/WhatsApp</span>
                            <br><br>
                            <button type="button" class="btnAzul" id="btnEspecificacoesMetaMsgeAtivaPf">Ver especificações</button>
                            <br>
                            Confira no link:
                            <a href = "https://developers.facebook.com/docs/whatsapp/on-premises/reference/media#supported-files" class="" target="_blank">https://developers.facebook.com/docs/whatsapp/on-premises/reference/media#supported-files</a>
                            <div class= "divUploadArquivo">
                                <label for="fileInputMidiaMetaMsgeAtivaPf" >
                                    <img src="https://cad.desenv.bb.com.br/lib/img/apps/solicitacoes/iconeUpload.png" class="Clicar"> 
                                    <span class="txtBtnEnviaArquivo">Enviar arquivo</span>
                                </label>    
                                <input type = "file" id= "fileInputMidiaMetaMsgeAtivaPf" class="uploadArquivoEscondido" accept =".pdf">
                            </div>
                        </div>     
                    </div>                     
                    <div class="divDireita">
                        <div class="divAlertaMidia">
                            <span class="textoAlertaMidiaMetaNegrito">Informação </span>
                            <br><br>
                            <span class = "textoAlertaMidiaMeta">
                                Providencie imagem que esteja relacionada ao BB e/ou tema/produto conforme especificações<br>
                                abaixo e anexe-a na História aberta no GenTI:<br>
                                Formato: PNG ou JPEG<br>
                                Tamanho máximo: 5 MB<br>
                                Dimensões: 500 x 500 px<br>
                                <br>
                                <br>
                                O uso de imagens, além de fortalecer a marca BB, também traz maior segurança e favorece <br>
                                maior interação dos usuários.
                                <br>
                                <br>
                                Recomendamos que a imagem não possua uma quantidade grande de texto, pois uma <br>
                                abordagem visual mais limpa e direta gera maior impacto e engajamento.
                            </span>    
                        </div>
                    </div>
                </div>
                <div class="nestBtnProximaPagina">
                    <button type="button" class="btnVoltar" id="btnVoltar4NovaJornadaPF">Voltar</button>
                    <button type="button" class="btnProximo" id="btnProximo7NovaJornadaPF">Próximo</button>
                </div>        
            </div>
            <div class="divPaginaForm" id="formPagina7" attr-numPagForm = "7">
                <div class="nestPerguntasFormulario">
                    <div class="divItemFormularioSolicitacaoClientePF divItemFormularioSolicitacaoLarguraMax">    
                        <span class="itemFormulario">Como os resultados da comunicação serão acompanhados e reportados?</span>
                        <div>
                            <textarea class="txtAreaMedioTransacao" name="acompanhamentoResultadoMensagemAtivaPF" rows="7" cols="155" maxlength="200" placeholder= "Mensagem"></textarea>
                        </div>
                    </div>
                </div>
                 <div class="nestBtnProximaPagina">
                    <button type="button" class="btnVoltar" id="btnVoltar3NovaJornadaPF">Voltar</button>
                    <button type="button" class="btnProximo" id="btnProximo4NovaJornadaPF">Cadastrar</button>
                </div>   
            </div>     
        </div><!--Fim da Aba de Nova Solicitação-->
