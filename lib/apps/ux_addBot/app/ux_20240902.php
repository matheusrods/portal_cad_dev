    ...
    <div class="designSystemUx">
        <div class="divTextoApresentacaoDesignSystemUx">
            ...
            <div class="divVideoFazapFigmaUx" style="padding-right: 47px;">
                <a href="https://banco365.sharepoint.com.mcas.ms/sites/CuradoriaUAUFeedbackPFePJ/Shared%20Documents/Forms/AllItems.aspx?FolderCTID=0x0120003FAD01410E771F40BE01E2D23A299E4C&id=%2Fsites%2FCuradoriaUAUFeedbackPFePJ%2FShared%20Documents%2FBem%20vindo%20ao%20CAD%2FFazap%20Figma%20%2D%20Turma%203%2D20220325%5F110203%2DGrava%C3%A7%C3%A3o%20de%20Reuni%C3%A3o%2Emp4&parent=%2Fsites%2FCuradoriaUAUFeedbackPFePJ%2FShared%20Documents%2FBem%20vindo%20ao%20CAD" target="_blank">
                    <div style="width: 657px; height: 313px; position: relative">
                        <img style="width: 657px; height: 313px; left: 0px; top: 0px; position: absolute; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 47px" src="https://cad.bb.com.br/lib/img/apps/ux/fazapFigmaUx.png" />
        ...
        <div style="align-self: stretch; padding-left: 128px; padding-right: 128px; justify-content: flex-start; align-items: flex-start; display: inline-flex; margin-top: 16px;">
            <div style="flex: 1 1 0">
                <p style="color: #49494F; font-size: 24px; font-family: BancoDoBrasil Textos; font-weight: 400; word-wrap: break-word">
                    ...
                    <br><br>
                    E para ajudar no dia a dia, <b>criamos o nosso design system</b> para os canais mais utilizados, para acessar basta clicar na imagem do canal desejado.
                </p>
            </div>
        </div>

        <div class="cardsDesignSystemUx">
            <div class="cardAlexaWhatsappUx">
                <a href="https://www.figma.com/file/9UuRSfdmN0Y3THq6q52fUt/Template-Squad-Voz-V2%281%29?type=design&node-id=1937:1187&mode=design&t=D2NFGb1b5VSdXEOe-1" target="_blank">
                    <img src="https://cad.bb.com.br/lib/img/apps/ux/cardAlexaUx.png" alt="Design System Alexa">
                </a>
            </div>
            <div class="cardAlexaWhatsappUx">
                <a href="https://www.figma.com/file/FVyPbGQEQh6mJihomQRFxG/Template-V2-Real-Oficial?node-id=0:1092&t=N86zOhxjirmsVjw6-0" target="_blank">
                    <img src="https://cad.bb.com.br/lib/img/apps/ux/cardWhatsappUx.png" alt="Design System WhatsApp">
                </a>
            </div>
        </div>
