...
echo '<!-- CSS específico do app --><link href="/lib/apps/ux_addBot/css/ux.css" rel="stylesheet">';
...
<div class="capaUx" style="width: 100%;">
    <div class="divCapaUx">
        <div style="align-self: stretch; padding-top: 64px; padding-bottom: 64px; background: #5379FF; justify-content: center; align-items: center; gap: 16px; display: inline-flex">
            ...
            <a href="https://cad.bb.com.br/bot_guia/index.php">
                <img id="divChamaBot" src="https://cad.bb.com.br/lib/img/img_bot/chamaBot.svg">
            </a>
        </div>
    </div>
