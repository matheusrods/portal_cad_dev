...
$recursos = $class->carregaRecursos();
$experimentos = $class->carregaExperimentos();
$paineis = $class->carregaPaineis();
$estudos = $class->carregaEstudos();
$copilotos = $class->carregaCopilotos();
$plataformas = $class->carregaFerramentaPlataformas();
$desenvolvimento = $class->carregaFerramentaDesenvolvimento();
$ativo = $class->carregaFerramentaAtivo();
$portais = $class->carregaFerramentaPortais();
...
<head>
    ...
    <script type="text/javascript" src="../lib/apps/home/js/confetesAniversarioCad.js"></script>


    <!-- JS para pegar o host da página e passar como variável para as funções internas do index.js -->
    ...
    <main>
        ...
        <div id="container">
            <?php
                ...
                $escondeDivEcoa = "";
                if($dependencia=='1901' || $mat=="C1314420"){
                    $escondeDivEcoa = 'style="display: inline-flex;"';
                } 
                ...
                startVelocity: 45,
                        ...
                        <div id="paginaHome">
                            <div id="homeCabecalho">
                                <!--<div id="cabecalhoEsquerdo">
                                    ...
                                    <div id="divTextoCabecalho">
                                        ...
                                        <br><br>
                                        <span class="txtCabecalho">Acompanhe todas as novidades sobre os assistentes virtuais do BB</span>
                                    </div>
                                </div>
                                ...
                                <div id="divSuperiorAsstDig">
                                    <div id="divTxtTituloAssDigSuperior">
                                        ...
                                        <div id="divTxtAssDigi">    
                                            ...
                                            <span class="txtAssDigiNegrito">Centro de Assistentes Digitais (CAD)</span> é responsável pelo desenvolvimento dos <span class="txtAssDigiNegrito">assistentes conversacionais para os clientes do Banco do Brasil</span>, que estão disponíveis em várias plataformas, como o App BB, Instagram, Facebook e, principalmente, WhatsApp.
                                            <br>
                                            <br> 
                                            Os assistentes virtuais são aplicações de inteligência artificial e são desenvolvidos com <span class="txtAssDigiNegrito">ferramentas internas </span>do BB, como o NIA, e parcerias com grandes empresas de tecnologia como a IBM e Google. Tudo isso para garantir a <span class="txtAssDigiNegrito">melhor experiência </span> de atendimento ao cliente.</span> 
                                        </div>    
                                    </div>    
                                </div>
                            ...
                            <div class="divAvisosEcoa" '.$escondeDivEcoa.'>
                            ...
                            <div class ="areaReportDestaques">
                                ...
                                <div class="linhaDivisoriaReport"></div>
                                <div class="divItemReport">
                            ...
                            <div class="nestMenu">
                                <div id="menuAreaPortal">
                                    <div class="itemMenuAreasEmFoco Clicar" id="menuCopilotos"  attr-ativo = "1";>
                                        ...
                                        <span class="itemMenuSelecionado" id="idSpanCopilotosMenu">Copilotos</span>

                                    </div>
                                    <div class="itemMenuAreas Clicar" id="menuRecursos"  attr-ativo = "0";>
                                    ...
                                    <div class="itemMenuAreas Clicar" id="menuExperimentacoes"  attr-ativo = "0";>
                                    ...
                                    <div class="itemMenuAreas Clicar" id="menuPaineis"  attr-ativo = "0";>
                                    ...
                                    <div class="itemMenuAreas Clicar" id="menuEstudos" attr-ativo = "0";>
                                    ...
                                    <div class="itemMenuAreas Clicar" id="menuPesquisas" attr-ativo = "0";>
                                        ...
                                        <span class="itemMenuNaoSelecionado" id="idSpanPesquisasMenu">Pesquisas</span>
                                    </div>
                                </div> <!-- Fim div menu -->
                            </div><!-- fim div nest menu -->
                            <div id ="resumoAreasPortal">
                                <div class="carregaImagens"></div>
                                <div id="areaPesquisas">
                                    <div class="nestPesquisas">
                                        '.$pesquisas['mensagem'].'
                                    </div>
                                    <div class="verTodosAreaNest Clicar" attr-linkinterno="estudosPesquisas">
                                        <div class="btnVerTodosArea">
                                            <span class="spanVertodosArea">ver todos</span> 
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" viewBox="0 0 8 14" fill="none">
                                                <path d="M1.52227 0.5L0 2.0275L4.94467 7L0 11.9725L1.52227 13.5L8 7L1.52227 0.5Z" fill="white"/>
                                            </svg>
                                        </div>    
                                ...
                                <div id="areaRecursos">
                                    <div class="nestRecursos">
                                        '.$recursos['mensagem'].'
                                    </div>
                                    <div class="verTodosAreaNest Clicar" attr-linkinterno="recursos">
                                        <div class="btnVerTodosArea">
                                            <span class="spanVertodosArea">ver todos</span> 
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" viewBox="0 0 8 14" fill="none">
                                                <path d="M1.52227 0.5L0 2.0275L4.94467 7L0 11.9725L1.52227 13.5L8 7L1.52227 0.5Z" fill="white"/>
                                ...
                                <div id="areaExperimentacoes">
                                    <div class="nestExperimentacoes">
                                        '.$experimentos['mensagem'].'
                                    </div>
                                    <div class="verTodosAreaNest Clicar" attr-linkinterno="experimentos">
                                        <div class="btnVerTodosArea">
                                            <span class="spanVertodosArea">ver todos</span> 
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" viewBox="0 0 8 14" fill="none">
                                                <path d="M1.52227 0.5L0 2.0275L4.94467 7L0 11.9725L1.52227 13.5L8 7L1.52227 0.5Z" fill="white"/>
                                ...
                                <div id="areaPaineis" >
                                    <div class="nestPaineis">
                                        '.$paineis['mensagem'].'
                                    </div>
                                    <div class="verTodosAreaNest Clicar" attr-linkinterno="paineis">
                                        <div class="btnVerTodosArea">
                                            <span class="spanVertodosArea">ver todos</span> 
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" viewBox="0 0 8 14" fill="none">
                                                <path d="M1.52227 0.5L0 2.0275L4.94467 7L0 11.9725L1.52227 13.5L8 7L1.52227 0.5Z" fill="white"/>
                            ...
                            </div> <!-- Fim div áreas portal-->
                            <div class="areaFerramentas">
                                <div class="divCategoriasFerramentasMenu">
                                    <div class="divFerramentasTituloMenu">
                                        <span class="spanFerramentasTituloMenu">Ferramentas</span>
                                    </div>    
                                    <div class="divMenuCategoriasFerramentas">
                                        <span class="spanMenuCategoriasFerramentas Clicar" id="titMenuPlataforma">Plataformas</span>
                                        <span class="spanMenuCategoriasFerramentas Clicar" id="titMenuDesenvolvimento">Desenvolvimento</span>
                                        <span class="spanMenuCategoriasFerramentas Clicar" id="titMenuAtivo"> Ativo</span>
                                        <span class="spanMenuCategoriasFerramentas Clicar" id="titMenuPortais">Portais</span>
                                    </div>
                                </div> <!--fim menu das ferramentas-->
                                <div class="nestFerramentas">
                                    '.$plataformas['mensagem'].'
                                    '.$desenvolvimento['mensagem'].'
                                    '.$ativo['mensagem'].'
                                    '.$portais['mensagem'].'
                                    <!--'.$adicionaAvisoEcoa['mensagem'].'-->
                                </div><!-- fim div nest ferramentas -->
                            </div>
                        </div> <!--Fim div home -->
