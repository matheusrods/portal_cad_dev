...
if(!isset($_SESSION['matricula'])){
    ...
    header('Location: https://login.intranet.bb.com.br/sso/XUI/?goto=https://cad.bb.com.br/formulario_imersao/');
    die;
}
            ...
            <div>
                <form method= "post" class="formularioImersao">
                    ...
                    <div id = "formularioImersaoPagina2" class ="paginaFormularioImersao" style="display: none; width: 82%;">
                        ...
                        <input type="button" class="btnVoltarForm" value="Voltar" onclick="mostraDiv1()" attr-qualDiv="1" style = "margin-top: 16%; ">                    
                    ...
                    <div id = "formularioImersaoPagina3" class ="paginaFormularioImersao" style="display: none; width: 82%;">
                        ...
                        <input type="button" class="btnVoltarForm" value="Voltar" onclick="mostraDiv2()" style = "margin-top: 16%;">                    
                    ...
                    <div id = "formularioImersaoPagina4" class ="paginaFormularioImersao" style="display: none; width: 82%;">    
                        ...
                        <input type="button" class="btnVoltarForm" value="Voltar" id= "btnFinalFormularioOnlinePresencial" onclick="mostraDiv3()" >                    
                        <input id="finalizar" type="button" class="btnContinuarForm" id= "btnFinalFormularioOnlinePresencial" value="Continuar"><br>
