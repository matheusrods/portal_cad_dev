...
<body>
    ...
    <section class="hero">
        <div class="container hero-container">
            ...
            <div class="hero-image">
                <img src="https://cad.desenv.bb.com.br/lib/apps/capacitacao_analytics/img/robo.png" alt="Robô CAD">
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function activateTab(name) {
            ...
            // fetch da seção
            const url = `https://cad.desenv.bb.com.br/lib/apps/capacitacao_analytics/sections/${name}.php`;
            fetch(url)
            .then(r => {
