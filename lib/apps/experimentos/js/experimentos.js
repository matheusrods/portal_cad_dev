$(document).ready(function() {
    ...
    $(".botaoVerMaisExperimentos").on('click', function (event) {
        ...
        var $linha = $(".abreDivNestExperimento[attr-sequencia="+novoSequencial+"]");
    ...
    function consultaExperimentos(idTema){
        var caminhoController = 'https://cad.bb.com.br/lib/apps/experimentos/controller/controller_experimentos.php';
        $.ajax({
            aSync: true,
