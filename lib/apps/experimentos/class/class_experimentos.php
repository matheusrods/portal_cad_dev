...
Class funcoes {
        ...
        try{
            ...
            if($execQuery > 0){
                ...
                for($j = 0; $j < sizeof($execQuery); $j++){
                    ...
                    $queryTemasExperimento = "SELECT temas FROM experimentos.experimentosTemas a
                                                LEFT JOIN experimentos.temas b ON a.idTema = b.idTema
                    ...
                    $montaExperimentos = $montaExperimentos.$abreDivNestExperimento.'
                        <div class="divExperimento">
                            <a href="https://cad.bb.com.br/lib/apps/experimentos/arquivos/'.$idExperimento.'.pdf" target="_blank" style="text-decoration: none; width: 100%;">
                                <div class="fotoCapaExperimento" style="background-image: url(https://cad.bb.com.br/lib/apps/experimentos/arquivos/'.$idExperimento.'.png); background-size: 100%; background-repeat: no-repeat; background-position: center; background-color: #8ff3ad;">
                                    '.$tagsExperimentos.'
                                </div>
                            </a>
    ...
    public function adicionaExperimento(){
        ...
        try{
            ...
            //     $montaSelect = '<div class="selectTemas"><select id="temaSelecionadoSelect" tabindex=6><option value="0">Selecione o tema:</option>';
                
            //     for($i = 0; $i < sizeof($execQueryMontaSelect); $i++){
            //         $montaSelect = $montaSelect.'<option value="'.$execQueryMontaSelect[$i]["idTema"].'">'.$execQueryMontaSelect[$i]["temas"].'</option>';
            //     }
        ...
        $resposta['mensagem'] = '
            ...
            <script>
                ...
                $(".btnLimparExperimentos").on("click", function(){
                    ...
                    $(".chip").css("background-color", "rgb(229, 229, 229)");
                    $(".chip").css("color", "rgb(0, 0, 0)");
