...
echo '
    <div class="descricaoQuemSomos">
        ...
        <div class="textoDescricaoQuemSomos">
            <span style="color: #49494F; font-size: 18px; font-family: BancoDoBrasil Textos; font-weight: 400; word-wrap: break-word">Somos a <b style="color: #49494F; font-size: 18px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word">Centro de Assistentes Digitais</b>!<br><br>
            </span>
...
for($i = 0; $i < sizeof($consultaVagas['mensagem']); $i++){
    $montaDivVagas = $montaDivVagas.'
        <div style="width: 10rem; height: 24rem; background: white; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 16px; flex-direction: column; justify-content: center; align-items: center; gap: 8px; display: inline-flex">
            <div class="qtdVagas" style="text-align: center; color: #49494F; font-size: 160px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word">'.$consultaVagas['mensagem'][$i]['qtdVagas'].'</div>
            <div class="descCargo" style="text-align: center; color: #49494F; font-size: 16px; height: 30%; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word">'.$consultaVagas['mensagem'][$i]['descricaoFuncao'].'</div>
            <div class="codVaga" style="text-align: center; color: black; font-size: 13px; height: 30%; font-family: BancoDoBrasil Textos; font-weight: 300; word-wrap: break-word">'.$consultaVagas['mensagem'][$i]['codVaga'].'</div>
        </div>
    ';
}
...
<div class="temosVagas">
    ...
    <div class="quadroVagas">
        ...
        <div class="quadroVagasQuantidade">'.$montaDivVagas.'</div>
            ...
            <div style="width: 100vw; text-align: center; color: #49494F; font-size: 32px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word; margin-top: 16px;">Conheça o Programa de Formação do CAD</div>
            <div class="quadroInscreva" class>
