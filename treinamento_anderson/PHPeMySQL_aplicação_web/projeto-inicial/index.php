<?php
    $produtosCafe = [
        [
            'nome' => "Café Cremoso",
            'descrição' => "Café cremoso irresistivelmente suave e que envolve seu paladar",
            'preço' => "5.00",
            'imagem' => "img/cafe-cremoso.jpg"
        ],
        [
            'nome' => "Café com Leite",
            'descrição' => "A harmonia do café e do leite, uma experiência reconfortante",
            'preço' => "2.00",
            'imagem' => "img/cafe-com-leite.jpg"
        ],
        [
            'nome' => "Cappuccino",
            'descrição' => "Café suave, leite cremoso e uma pitada de sabor adocicado",
            'preço' => "7.00",
            'imagem' => "img/cappuccino.jpg"
        ],
        [
            'nome' => "Café Gelado",
            'descrição' => "Café gelado refrescante, adoçado e com notas sutis de baunilha ou caramelo.",
            'preço' => "3.00",
