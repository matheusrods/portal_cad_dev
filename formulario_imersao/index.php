...
if($_SESSION["nome"] == ""){
    header("Location: https://login.intranet.bb.com.br/sso/XUI/?goto=https://cad.bb.com.br/formulario_imersao/#login/");
}
...
<body>
    ...
    <main>
        <div id="container">
            <?php
                include_once $_SERVER["DOCUMENT_ROOT"]."/lib/apps/mentoria/app/formulario.php";
            ?>
        </div>
    </main>
</body>