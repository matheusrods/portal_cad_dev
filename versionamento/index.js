...
function registrar_tabela(motivo){
    ...
    const mes = (dataHora.getMonth() + 1).toString().padStart(2, '0'); // Month is 0-indexed
    ...
    if (tabelaTarefas[tabelaTarefas.length - 1].length === 0) {
        tabelaTarefas.pop();
    };
    tabelaTarefasJson = tabelaTarefas.map(row => ({
        versao: versaoNumero,
