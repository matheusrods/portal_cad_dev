...
function enviarMensagem() {
    var caminhoController = 'https://cad.bb.com.br/bot_dev/controller.php';
    ...
    $.ajax({
        ...
        success: function(retorno) {
            ...
            .then(data => {
                ...
                exibirMensagem('Assistente', respBotPulaLinha, 'bot');
            ...
            .catch(error => {
                ...
                exibirMensagem('Assistente', 'Desculpe, não estou <i>cão</i>seguindo consultar minha base de conhecimento agora.', 'bot');
            });
            retorno = null;
        }
    });
