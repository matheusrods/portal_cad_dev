<?php 
    ...
    $caminhoImgCapa = "https://cad.bb.com.br/tom/img/logoBotTomSombra.png";
    $estiloJanelaChat = '';

    if((date("Y-m-d")) <= "2024-12-31"){
        $caminhoImgCapa = "https://cad.bb.com.br/tom/img/tomNatal.png";
...
<div id="chatbot-container">
    ...
    <div id="chat-window" class="hidden" <?php echo $estiloJanelaChat; ?>>
        <div id="chat-header">
            <img src="https://cad.bb.com.br/tom/img/gatoTomChat.png" alt="Imagem da mascote Bot ao lado do cabeçalho" style="width: 50px; height: 50px;">
