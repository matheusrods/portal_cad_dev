<?php 
    ...
    $caminhoImgCapa = "https://cad.desenv.bb.com.br/tom/img/logoBotTomSombra.png";
    $estiloJanelaChat = '';
...
<div id="chatbot-container">
    <!-- <img src="https://cad.desenv.bb.com.br/tom/img/BackgroundTom.png" alt="Imagem da mascote Bot ao lado do cabeçalho"> -->
            ...
            <div id="chat-input-container">
                <div class="input" style="width: 100%; display: inline-flex">                    
                    ...
                    <div class ="botaoAnexarEnviar">    
                        <button class="anexarArquivo"><img src="https://cad.desenv.bb.com.br/tom/img/monotone.png"> Anexar</button>       
                        ...
                        <button id="send-message"><span>Enviar</span><img src="https://cad.desenv.bb.com.br/tom/img/iconeButton.png"></button>
                    </div>
                </div>
            </div>
