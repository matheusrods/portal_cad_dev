...
if($_SESSION["nome"] == ""){
    header("Location: https://login.intranet.bb.com.br/sso/XUI/?goto=https://cad.bb.com.br/incidentes/#login/");
}
...
<body>
    ...
    <main>
        <div id="container">
            <?php
                include_once $_SERVER["DOCUMENT_ROOT"]."/lib/apps/incidentes/app/incidentes.php";
            ?>
        </div>
    </main>
    <script>
        $(document).ready(function() {
            $('.divCabecalho.linkInterno.Clicar[attr-linkinterno="incidentes"]').click();
        });
    </script>
</body>