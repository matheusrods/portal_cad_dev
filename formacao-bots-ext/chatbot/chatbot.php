...
<div id="chatbot-container">
    ...
    <div id="chat-window" class="hidden">
        <div id="chat-header">
            <img src="https://cad.bb.com.br/formacao-bots/img/iconeBotCabecalhoChat.png" alt="Imagem da mascote Bot ao lado do cabeçalho" style="width: 50px; height: 50px;">
            <h2>Assistente Virtual do CAD</h2>
            <button id="close-chat">&times;</button>
        </div>
        <div id="chat-content">
            <div id="chat-messages"></div>
            <div class="message bot"><strong>Assistente:</strong> Olá! Como posso te ajudar sobre o Programa de Formação?</div>
        </div>
