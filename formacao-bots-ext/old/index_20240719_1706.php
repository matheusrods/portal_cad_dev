...
<html lang="pt-BR">
    ...
    <body style="background: #465EFE no-repeat center center fixed; background-image: url('img/fundoFull.svg'); background-attachment: fixed; max-width: 100%; overflow-x: hidden;">
        <header>
            ...
            <div style="width: 555.11px; height: 519px; left: 682px; top: -8.5rem; position: absolute" tabindex="2">
                <img style="width: 363.57px; height: 332.37px; left: 69.77px; top: 129.24px; position: absolute;" src="img/capa.png" alt="Capa do hotsite sendo uma mão segurando um celular com o robô mascote do CAD saindo de dentro da tela deste celular." />
            </div>

            

            <h1 style="width: 323px; height: 114px; left: 826px; top: 18rem; position: absolute"  tabindex="3">
                <span style="width: 20rem; height: 11px; left: 5px; top: 0px; position: absolute; color: white; font-size: 11px; font-family: BancoDoBrasil Textos; font-weight: 300; letter-spacing: 5.83px; word-wrap: break-word">PROGRAMA DE FORMAÇÃO</span>
                <span style="width: 35rem; height: 56px; left: 0px; top: 6px; position: absolute; color: white; font-size: 60px; font-family: BancoDoBrasil Textos; font-weight: 300; word-wrap: break-word">Especialista</span>
                <span style="width: 2rem; height: 13px; left: 67px; top: 66px; position: absolute; color: white; font-size: 11px; font-family: BancoDoBrasil Textos; font-weight: 300; word-wrap: break-word">em</span>
                <span style="width: 35rem; height: 62px; left: 80px; top: 52px; position: absolute; color: white; font-size: 64px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word">Chatbot</span>
            </h1>
            
            <div style="width: 100%; height: 22px; left: 659px; top: 30rem; position: absolute">
                <div style="width: 39rem; height: 22px; left: 0px; top: 0px; position: absolute; background: #00FFA3; border-radius: 8px"></div>
                <div style="width: 100%; height: 14px; left: 7.30px; top: 5px; position: absolute">
                    <a class="Clicar" style="color: #5F5F5F; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word" tabindex="4">INÍCIO</a>
                    <a style="color: #13E89A; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word">|</a>
                    <a class="Clicar" style="color: #5F5F5F; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word" tabindex="5">PRÉ-REQUISITOS</a>
                    <a style="color: #13E89A; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word">|</a>
                    <a class="vaiParaDiv Clicar" attr-qualDiv="inscricoes" style="color: #5F5F5F; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word" tabindex="6">INSCRIÇÃO</a>
                    <a style="color: #13E89A; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word">|</a>
                    <a class="vaiParaDiv Clicar" attr-qualDiv="etapas" style="color: #5F5F5F; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word" tabindex="7">ETAPAS</a>
                    <a style="color: #13E89A; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word">|</a>
                    <a class="Clicar" style="color: #5F5F5F; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word" tabindex="8">  LINHA DO TEMPO  </a>
                    <a style="color: #13E89A; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word">|</a>
                    <a class="Clicar" style="color: #5F5F5F; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word" tabindex="9">  REGULAMENTO  </a>
                    <a style="color: #13E89A; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word">|</a>
                    <a class="Clicar" style="color: #5F5F5F; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word" tabindex="10">  FAQ  </a>
                    <a style="color: #13E89A; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word">|</a>
                    <a class="Clicar" style="color: #5F5F5F; font-size: 12px; font-family: BancoDoBrasil Textos; font-weight: 700; word-wrap: break-word" tabindex="11">  RESULTADO</a>
                </div>
            </div>
        </header>
        ...
        <main>
            <div id="container" style="width: 100%; height: auto; position: relative;">
                ...
                <!-- <div id="apresentacao" style="position:relative;"  tabindex="12"> -->
                <div id="apresentacao" tabindex="12">
                    <h2 style="top: 20rem; position: absolute; opacity: 0.05; color: white; font-size: 200px; font-family: BancoDoBrasil Textos; font-weight: 800; word-wrap: break-word">apresentação</h2>
                    <h3 style="left: 422px; top: 36rem; position: absolute">
                    ...
                    <div style="width: 1077px; height: 209px; left: 422px; top: 42rem; position: absolute"  tabindex="13">
                ...
                <!-- <div id="inscricoes" style="position:relative;" tabindex="20"> -->
                <div id="inscricoes" tabindex="20">
                    <h2 style="top: 85rem; position: absolute; opacity: 0.05; color: white; font-size: 200px; font-family: BancoDoBrasil Textos; font-weight: 800; word-wrap: break-word">
                        inscrições
                    </h2>
                ...
                <!-- <div id="requisitos" style="position:relative;"> -->
                <div id="requisitos">
                    <h2 style="top: 115rem;position: absolute;opacity: 0.05;color: white;font-size: 200px;font-family: BancoDoBrasil Textos;font-weight: 800;word-wrap: break-word" tabindex="23">
                        requisitos
                    </h2>
                ...
                <!-- <div id="etapas" style="position:relative;"> -->
                <div id="etapas" style="min-height:1100px;">
                    <div style="top: 170rem; position: absolute; opacity: 0.05; color: white; font-size: 200px; font-family: BancoDoBrasil Textos; font-weight: 800; word-wrap: break-word">
                        etapas
                    </div>
                    <h2 style="width: 100%; position: absolute; top: 174rem; left: 23rem; color: white; font-size: 28px; font-family: BancoDoBrasil Textos; font-weight: 300; word-wrap: break-word;" tabindex="35">
                        Etapas:
                    </h2>
                ...
                <!-- <div id="linhaDoTempo" style="position:relative;"> -->
                <div id="linhaDoTempo">
                    <div style="top: 254rem; position: absolute; opacity: 0.05; color: white; font-size: 200px; font-family: BancoDoBrasil Textos; font-weight: 800; word-wrap: break-word" tabindex="46">
                        linha do tempo
                    </div>
