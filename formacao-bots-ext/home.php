            ...
            <div class="divExternaCabecalho">
                <div class="divInternaCabecalho">
                    <nav>
                        ...
                        <a>|</a>
                        <button onclick="scrollToSection('h2Resultados')" class="botaoNavega Clicar" tabindex="11">RESULTADO</button>
                    </nav>
                </div>
            </div>
        </header>
                ...
                <div id="linhaDoTempo">
                    ...
                    <div style="width: 100%; height: 407px; position: relative;">
                        ...
                        <div style="width: 288px; height: 207px; left: -10px; top: 3rem; position: absolute; z-index: 1;">
                            <a href="/formacao-bots/arquivos/regulamentoProgramaFormacaoFinal.pdf" target="_blank" style="display: block; /*width: 275px; height: 215px;*/">
                           ...
                           <div id="AtualizacaoRegulamento"> *OBS: versão atualizada em 24/10</div>
                        </div>
                        ...
                        <div class="divVideoAulas">
                            <div class="aula01 divAula">
                                ...
                                <div class="divTituloVideoAulas">
                                    ...
                                    <div class="botoesAula">
                                        <!-- <a href="https://banco365-my.sharepoint.com/personal/alinecastrosantos_bb_com_br/_layouts/15/stream.aspx?id=%2Fpersonal%2Falinecastrosantos%5Fbb%5Fcom%5Fbr%2FDocuments%2FGrava%C3%A7%C3%B5es%2FAula%201%5F%20Onboarding%5F%20da%20ideia%20ao%20HLD%20%28High%20Level%20Design%29%2D20241007%5F140527%2DGrava%C3%A7%C3%A3o%20de%20Reuni%C3%A3o%2Emp4&ga=1&referrer=StreamWebApp%2EWeb&referrerScenario=AddressBarCopied%2Eview%2E987aafdb%2Dbcb3%2D43b9%2Da3d6%2D9a4eb91c15cc" target="_blank" style="text-decoration: none;"> -->
                                        <a href="https://banco365-my.sharepoint.com/:v:/g/personal/alinecastrosantos_bb_com_br/ER8NNaxxXA5Cq8p-OWbBPaQBVb3YzBsgIBGsMNL854DIKA" target="_blank" style="text-decoration: none;">
                                            <div class="botaoAula acessaAula">
                                                Acessar aula
                                            </div>
                                        </a>
                                        <a href="/formacao-bots-ext/arquivos/aula01.zip" target="_blank" style="text-decoration: none;">
                                            <div class="botaoAula acessaRecurso">
                                                Recursos
                                            </div>
                                        </a>
                                    </div>
                            ...
                            <div class="aula02 divAula">
                                ...
                                <div class="divTituloVideoAulas">
                                    ...
                                    <div class="botoesAula">
                                        <a href="https://banco365-my.sharepoint.com/:v:/g/personal/alinecastrosantos_bb_com_br/EV9UXa2nBWxBp8K9Rp2tmpMBtVmVsmnP8p32fEn4iwU7cw" target="_blank" style="text-decoration: none;">
                                            <div class="botaoAula acessaAula">
                                                Acessar aula
                                            </div>
                                        </a>
                                        <a href="/formacao-bots-ext/arquivos/aula02.zip" target="_blank" style="text-decoration: none;">
                                            <div class="botaoAula acessaRecurso">
                                                Recursos
                                            </div>
                                        </a>
                            ...
                            <div class="aula03 divAula">
                                ...
                                <div class="divTituloVideoAulas">
                                    ...
                                    <div class="botoesAula">
                                        <a href="https://banco365-my.sharepoint.com/:v:/g/personal/alinecastrosantos_bb_com_br/EWV3cXu9FMtBjCLf4kOYv0EBzxndjNW5VIcz_jo8DOyLig" target="_blank" style="text-decoration: none;">
                                            <div class="botaoAula acessaAula">
                                                Acessar aula
                                            </div>
                                        </a>
                                        <a href="/formacao-bots-ext/arquivos/aula03.zip" target="_blank" style="text-decoration: none;">
                                            <div class="botaoAula acessaRecurso">
                                                Recursos
                                            </div>
                                        </a>
                            ...
                            <div class="aula04 divAula">
                                ...
                                <div class="divTituloVideoAulas">
                                    ...
                                    <div class="botoesAula">
                                        <a href="https://banco365-my.sharepoint.com/:v:/g/personal/alinecastrosantos_bb_com_br/EcHER0RUtcpHrdUu7WZAwZsB7IwaPqrb4bLE9VDjMFavyQ" target="_blank" style="text-decoration: none;">
                                            <div class="botaoAula acessaAula">
                                                Acessar aula
                                            </div>
                                        </a>
                                        <a href="/formacao-bots-ext/arquivos/aula04.zip" target="_blank" style="text-decoration: none;">
                                            <div class="botaoAula acessaRecurso">
                                                Recursos
                                            </div>
                                        </a>
                    ...
                    <div class="quadroResultados">
                        ...
                        <div class="divAcessaResultados">
                            <div class="acessaResultado resultado05">
                                <div class="tituloResultado">Selecionados para o programa</div>
                                <div class="botaoAcessaResultado"> <a href="/formacao-bots-ext/arquivos/listaRecrutados_20241004.pdf">Acessar resultado</a></div>
                            </div>
                            <div class="acessaResultado resultado01">
                                <div class="tituloResultado">Onboarding: da ideia ao HLD</div>
                                <a href ="/formacao-bots-ext/arquivos/listaSelecionadosAulaOnBoarding.pdf" target = "_blank"><div class="botaoAcessaResultado"> Acessar resultado</div></a>
                            </div>
                            <div class="acessaResultado resultado01">
                                <div class="tituloResultado">Ferramentas e arquitetura</div>
                                    <a href = "/formacao-bots-ext/arquivos/listaSelecionadosAulaFerramentasArquitetura.pdf" target="_blank"><div class="botaoAcessaResultado"> Acessar resultado</div></a>
                            </div>
                            <div class="acessaResultado resultado03">
                                ...
                                <div class="botaoAcessaResultado">
                                    <a href = "/formacao-bots-ext/arquivos/listaSelecionadosAulaDisparosAtivos.pdf" target="_blank">
                                        Acessar resultado
                                    </a>
                                </div>
                            </div>
                            <div class="acessaResultado resultado04">
                                ...
                                <div class="botaoAcessaResultado">
                                    <a href = "/formacao-bots-ext/arquivos/listaSelecionadosEstagio.pdf" target="_blank">
                                        Acessar resultado
                                    </a>
                                </div>
                            </div>
                            <div class="acessaResultado resultado05">
                                ...
                                <div class="botaoAcessaResultado">
                                    <a href = "/formacao-bots-ext/arquivos/resultadoFinal.pdf" target="_blank">
                                        Acessar resultado
                                    </a>
                                </div>
                            </div>
